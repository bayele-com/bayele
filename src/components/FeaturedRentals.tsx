          ...
          {properties?.map((property) => (
            ...
            >
              ...
              <CardContent className="p-4">
                ...
                <p className="text-gray-600 text-sm mb-2">{property.neighborhood?.name}, {property.neighborhood?.city}</p>
                <p className="text-primary font-semibold">
                  {property.price.toLocaleString('fr-FR', { style: 'currency', currency: 'XAF' })}
